                        ...
                        <div class="p16">
                            <ul>
                                <li>
                                    <dl>
                                        <dt>ニックネーム</dt>
                                        <dd><?php echo $UserData['Snsuser']['name']?></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <dt>性別</dt>
                                        <dd><?php echo $UserData['Snsuser']['gender']?></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <dt>年齢</dt>
                                        <dd><?php echo $UserData['Snsuser']['birthday']?></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <dt>種別</dt>
                                        <dd><?php echo $UserData['Snsuser']['job']?></dd>
                                    </dl>
                                </li>
                            </ul>
                            <footer>
                                <a href="<?php echo WEBROOT?>mypage/" class="button btn-pk">登録情報を変更</a>
                            </footer>
                        </div>
                    </section><!-- /.review-user -->
<form method="post" action="<?php echo WEBROOT.$this->name?>/">
