...
<div class="tableWrap">
	<table id="demoTable">
		...
		<thead>
			<tr>
				...
				<?php foreach($Items as $Item):?>
					<th><?php echo $Item['Item']['id']?><?php echo $Item['Item']['title']?></th>
				<?php endforeach;?>
			</tr>
		</thead>
		<tbody>
		...
		<tbody class="table-head">
			<tr><td colspan="<?php echo count($Items) + 1;?>"><span>基本情報</span></td></tr>
		</tbody>
		<tbody>
			<tr>
				<th>小売希望価格</th>
		...
		<tbody class="table-head">
			<tr><td colspan="<?php echo count($Items) + 1;?>"><span>詳細情報</span></td></tr>
		</tbody>
		<tbody>
			<tr>
				<th>サイズ</th>
		...
		<tbody class="table-head">
			<tr><td colspan="<?php echo count($Items) + 1;?>"><span>ユーザーレビュー評価</span></td></tr>
		</tbody>
		<tbody>
			<tr>
				<th>ユーザーレビュー件数</th>
