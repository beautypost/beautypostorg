...
<form class="form-horizontal" role="form" method="post" action="<?php echo WEBROOT.$this->name?>/input">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
<input type="text" name="data[title]" value="<?php echo $data['AdminKeyword']['title']?>" class="col-xs-10" required>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
<input type="text" name="data[url]" value="<?php echo $data['AdminKeyword']['url']?>" class="col-xs-10" required>
...
<input type="hidden" name="data[id]" value="<?php echo $data['AdminKeyword']['id']?>">
</form>
    </div>
    </div>
    </div>
