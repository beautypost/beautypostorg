...
<section id="item-0001" class="collection-item box-contents">
    <header class="collection-head">
        <div>
            <div class="item-check"><input type="checkbox" id="item-ck-00001" name="item-ck-00001" value="item-00001"></div>
        ...
        <div class="item-summary">
            <dl class="item-rate">
                ...
                <dd class="monitor-rate">
                    ...
                    <span>（レビュー：<a href="./detail.html#review"><?php echo $Item['Item']['monitor']?>件</a>）</span>
                    <p>肌水分量平均（5名）25%→38%</p>
                </dd>
                <dt>ユーザーレビュー</dt>
                <dd class="user-rate">
                    <div class="star" data-score="3"></div>
                    <span>（レビュー：<a href="./detail.html#review"><?php echo $Item['Item']['review']?>件</a>）</span>
                </dd>
            </dl><!-- /.item-rate -->
