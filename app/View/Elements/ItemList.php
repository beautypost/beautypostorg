...
<section id="item-<?php echo $Item['Item']['id']?>" class="collection-item box-contents">
    <header class="collection-head">
        <div>
            ...
            <input type="checkbox" id="item-ck-<?php echo $Item['Item']['id']?>" onChange="compareItem(<?php echo $Item['Item']['id']?>)" name="item-ck-<?php echo $Item['Item']['id']?>" value="<?php echo $Item['Item']['id']?>" <?php echo $this->Useful->checked($ItemCompare,$Item['Item']['id'])?>></div>
