...
<?php foreach($BlogAccess as $item):?>
                        <li>
                            <a href="<?php echo WEBROOT?>Blog/detail/<?php echo $item['Blog']['id']?>">
...
<?php foreach($BlogNew as $item):?>
                        <li>
                            <a href="./detail.html">
                                <span class="entry-date"><?php echo $item['Blog']['created']?></span>
                                <span class="entry-title"><?php echo $item['Blog']['title']?></span>
...
<?php endforeach;?>
            ...
            <section id="news-category">
                ...
                <?php foreach($GenreBlogs as $item):?>
                    <li><a href="<?php echo WEBROOT?>Blog/<?php echo $item['Genre']['id']?>"><?php echo $item['Genre']['title']?></a></li>
                <?php endforeach;?>
                </ul>
