<h2 class="side-head"><!--
                ...
                <section class="mt0">
                    ...
                    <div class="round-contents-body">
                        <p class="question"><?php echo $Questions[0]['Question']['title']?></p>
                        <ul>
            ...
            <?php if(isset($Questions[1])):?>
                <section>
                    ...
                    <div class="round-contents-body">
                        <p class="question"><?php echo $Questions[1]['Question']['title']?></p>
                        <div class="answer">
                            <p class="total">総回答数：<span class="txt-c-pk"><?php echo $Questions[1]['Question']['totalpoints']?></span>件</p>
                            <table>
