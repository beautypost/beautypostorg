      ...
      <section class="column-famous container">
        ...
        <div class="section-body">
         ...
         <?php foreach($RankingColumns as $k => $v):?>
              ...
              <li>
                  <a href="<?php WEBROOT.$this->name?>detail/?id=<?php echo $v['Column']['id']?>">
      ...
      <section class="column-category container">
        ...
        <div class="section-body">
         ...
         <?php foreach($GenreColumn as $k => $v):?>
              <li><a href="<?php WEBROOT.$this->name?>category/?id=<?php echo $v['Genre']['id']?>"><?php echo $v['Genre']['title']?></a></li>
    <?php endforeach;?>
