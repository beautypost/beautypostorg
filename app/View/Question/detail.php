...
<div id="page-area">
	<div class="layout">
		<ol id="breadcrumb" class="breadcrumb rsp-xxoo">
			...
			<li><a href="<?php echo WEBROOT.$this->name?>/lists/">アンケートバックナンバー</a></li>
			<li>第00回 美容アンケート</li>
		</ol><!-- /#breadcrumb -->
		...
		<div id="main-area" class="layout-main layout-l">
			...
			<div>
				<nav class="pagination pg-list">
					<ul>
						...
						<li class="nav-back"><a href="./">一覧へ戻る</a></li>
			...
			<section class="enquete-section">
				<header>
					<h2 class="head-bar ico-arrow"><span class="rsp-xooo"><?php echo $Question['Question']['start']?> </span>第<?php echo $Question['Question']['id']?>回 美容アンケート</h2>
					<p><?php echo $Question['Question']['title']?></p>
				</header>

				<div class="section-body answer">
					<p class="total">総回答数：<span class="txt-c-pk">000</span>件</p>
					<table>
...
<?php endif;?>
						<li class="nav-back"><a href="<?php echo WEBROOT.$this->name?>/lists/">一覧へ戻る</a></li>
<?php if ($Pager['e']):?>
