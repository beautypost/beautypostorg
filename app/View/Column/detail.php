    ...
    <div id="main-area" class="layout-main layout-l">
      <article id="news-list">
        ...
        <section class="news-entry">
          <header>
            <h2 class="news-title head-bar"><?php echo $Column['Column']['title']?></h2>
            <p class="news-date"><?php echo $Column['Column']['entrydate']?></p>
          </header>
          <div class="news-body">
<!--
            <div class="photo">
              <div class="imgframe">
                <div class="inner"><?php echo $this->Useful->ItemImg($Column['Column']['img1up'],'300','Columns')?></div>
              </div>
            </div><!-- /.photo -->
