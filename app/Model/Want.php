...
//        $ret['created'] = $this->now();
    ...
    単数
    **/
    public function getAllWithGroupType() {
        $conditions = array(
//                            'genre_id'=>$genreID,
//                            'valid'=>1,
//                            'created <='=>$this->now()
    ...
    **/
    public function getItems($sort='',$limit='',$offset='',$tag='') {
        ...
        // }
        if($tag){
            $conditions['conditions'][] = array('category'=>$tag);
        }
...
//            'offset'    => $offset
    ...
    **/
    public function getItemsByCategory($categoryID) {
        $conditions = array(
            'conditions'=> array('category'=>$categoryID),
            // 'order'     => array($sort['key']=>$sort['value']),
            // 'limit'     => $limit,
            // 'offset'    => $offset
            );
