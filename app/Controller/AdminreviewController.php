 ...
 * @var array
 */
	public $uses = array('Snsuser','ItemsReview','GenreAttr','Attr');
 ...
 */
	public function index() {
		...
		$this->set('Items',$this->ItemsReview->getItems('',1000));
...
//        var_dump($genreattrs);
    ...
    public function valid(){
        ...
        $this->ItemsReview->invalid($id,$valid);
        $this->Index();
        $this->render('index');
        return;
    }
